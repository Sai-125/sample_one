...
const Main = () => {
  useEffect(()=>{
    localStorage.setItem('updateitems',JSON.stringify({id:'',image:'',description:'',title:'',price:'',rating:''}))
  },[])
...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://static.vecteezy.com/system/resources/previews/029/242/027/original/set-of-fresh-fruits-agriculture-farmers-market-local-produce-shopping-and-harvesting-text-poster-flat-illustration-vector.jpg" class="d-block w-100" alt="..."/>
    </div>
